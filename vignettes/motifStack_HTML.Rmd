...
kable(pcm, format = "latex", caption = "\\label{motifstackfig:PCM}Sample of PCM. Each row represents the counts of A, C, G and T, while each column is the counts for that nucleotide position.")
```


```{r, echo=FALSE}
pfm <- t(t(pcm)/colSums(pcm))
kable(pfm, format = "latex", digits=2,
