...
Here we clustered motifs for a smaller set of mouse Homeodomain(HDs) that were determined using two different experimental methods to measure DNA binding specificity, SELEX-seq and PBM, and different computational methods to generate the PBM motifs to confirm that the motif generation method can impact clustering. As it shown in Figre \ref{fig:MMdata} DREAM5 got low IC motifs and those motifs tend to cluster with each other (motifs 31-56).
